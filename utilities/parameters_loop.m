...
%   parameters
    ...
    DTp.final_drive,DTp.drivetrain_efficiency,DTp.G_d1,DTp.G_d2_overrun,DTp.G_d2_driving,Bp.brake_distribution,Bp.max_braking_torque,tP.gamma,tP.p_i);

for i = 1:numel(mass)
    aero = Aero(cda(i),cla(i),distribution(i));

    powertrain = Powertrain(redline(i),shift_point(i),eP.gears,eP.torque_fn,final_drive(i),wheel_radius(i),drivetrain_efficiency(i),...
